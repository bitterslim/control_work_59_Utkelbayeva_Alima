...
class User(models.Model):
    name = models.CharField(max_length=100, null=False, blank=False, verbose_name='User name')
    ...
    status = models.CharField(max_length=100, null=False, blank=False, default=StatusChoice.ACTIVE, verbose_name='Status')
